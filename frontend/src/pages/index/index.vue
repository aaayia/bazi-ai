  ...
  <div class="page-container">
    ...
    <div class="content-wrapper px-6">
      <div class="glass-card p-8">
        ...
        <div class="mt-10">
          <button @click="startCalculation" class="btn-primary w-full py-4 rounded-xl font-bold text-lg tracking-widest flex items-center justify-center gap-2">
            <span>开始排盘</span>
          </button>
        </div>
      </div>
...
const startCalculation = async () => {
  ...
  uni.showLoading({ title: '乾坤排盘中...', mask: true })
